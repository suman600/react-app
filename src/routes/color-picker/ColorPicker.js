...
import ImgViewer from "../../shared/imgViewer/imgViewer";
...
function ColorPicker() {
    ...
    const colorArr = [
        ...
        '#E1F5FE', '#B3E5FC', '#81D4FA', '#4FC3F7', '#29B6F6', '#03A9F4', '#03A9F4', '#03A9F4', '#0277BD', '#01579B',
            ...
            <div className="card card--color-picker">
                ...
                <div className="card-body">
                    <div className="btn-flex">
                        <button className={`btn btn-outline-dark ${isSampler ? 'active' : ''}`} onClick={clickSampler}>
                            <img src={pantone} alt={pantone} width={14} height={14}/>Sampler
                        </button>
                        <button className={`btn btn-outline-dark ${isImage ? 'active' : ''}`} onClick={clickImage}>
